...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerDirectory.alloted_timeout'
        db.add_column('customer_directory', 'alloted_timeout',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PyfbSettings.alloted_timeout'
        db.add_column('pyfbsettings', 'alloted_timeout',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=3600),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerDirectory.alloted_timeout'
        db.delete_column('customer_directory', 'alloted_timeout')

        # Deleting field 'PyfbSettings.alloted_timeout'
        db.delete_column('pyfbsettings', 'alloted_timeout')
