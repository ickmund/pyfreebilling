...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PyfbSettings'
        db.create_table('pyfbsettings', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
            ('logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
            ('default_currency', self.gf('django.db.models.fields.related.ForeignKey')(related_name='default_currency', to=orm['currencies.Currency'])),
            ('account1_swift_bic', self.gf('django_iban.fields.SWIFTBICField')(max_length=11, null=True, blank=True)),
            ('account1_iban', self.gf('django_iban.fields.IBANField')(max_length=34, null=True, blank=True)),
            ('account1_currency', self.gf('django.db.models.fields.related.ForeignKey')(related_name='account1_currency', to=orm['currencies.Currency'])),
            ('account1', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('account2_swift_bic', self.gf('django_iban.fields.SWIFTBICField')(max_length=11, null=True, blank=True)),
            ('account2_iban', self.gf('django_iban.fields.IBANField')(max_length=34, null=True, blank=True)),
            ('account2_currency', self.gf('django.db.models.fields.related.ForeignKey')(related_name='account2_currency', to=orm['currencies.Currency'])),
            ('account2', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('account3_swift_bic', self.gf('django_iban.fields.SWIFTBICField')(max_length=11, null=True, blank=True)),
            ('account3_iban', self.gf('django_iban.fields.IBANField')(max_length=34, null=True, blank=True)),
            ('account3_currency', self.gf('django.db.models.fields.related.ForeignKey')(related_name='account3_currency', to=orm['currencies.Currency'])),
            ('account3', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('vat_number', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('home_text', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'pyfreebill', ['PyfbSettings'])
        ...
        # Changing field 'EmailAddress.email_address'
        db.alter_column('contacts_email_addresses', 'email_address', self.gf('django.db.models.fields.CharField')(max_length=75))

    def backwards(self, orm):
        # Deleting model 'Taxes'
        db.delete_table('taxes')

        # Deleting model 'PyfbSettings'
        db.delete_table('pyfbsettings')
        ...
        # Changing field 'EmailAddress.email_address'
        db.alter_column('contacts_email_addresses', 'email_address', self.gf('django.db.models.fields.EmailField')(max_length=75))
    ...
    models = {
        ...
        u'pyfreebill.pyfbsettings': {
            ...
            'account1_currency': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'account1_currency'", 'to': u"orm['currencies.Currency']"}),
            ...
            'account2_currency': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'account2_currency'", 'to': u"orm['currencies.Currency']"}),
            ...
            'account3_currency': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'account3_currency'", 'to': u"orm['currencies.Currency']"}),
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'default_currency': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'default_currency'", 'to': u"orm['currencies.Currency']"}),
