...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PyfbSettings.homer_capture'
        db.add_column('pyfbsettings', 'homer_capture',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PyfbSettings.homer_server'
        db.add_column('pyfbsettings', 'homer_server',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PyfbSettings.homer_protocol'
        db.add_column('pyfbsettings', 'homer_protocol',
                      self.gf('django.db.models.fields.CharField')(default='udp', max_length=5),
                      keep_default=False)

        # Adding field 'PyfbSettings.homer_port'
        db.add_column('pyfbsettings', 'homer_port',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=9060),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PyfbSettings.homer_capture'
        db.delete_column('pyfbsettings', 'homer_capture')

        # Deleting field 'PyfbSettings.homer_server'
        db.delete_column('pyfbsettings', 'homer_server')

        # Deleting field 'PyfbSettings.homer_protocol'
        db.delete_column('pyfbsettings', 'homer_protocol')

        # Deleting field 'PyfbSettings.homer_port'
        db.delete_column('pyfbsettings', 'homer_port')
    ...
    models = {
        ...
        u'pyfreebill.customerdirectory': {
            ...
            'alloted_timeout': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'calls_per_second': ('django.db.models.fields.PositiveIntegerField', [], {'default': '10'}),
        ...
        u'pyfreebill.pyfbsettings': {
            ...
            'alloted_timeout': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            ...
            'homer_capture': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'homer_port': ('django.db.models.fields.PositiveIntegerField', [], {'default': '9060'}),
            'homer_protocol': ('django.db.models.fields.CharField', [], {'default': "'udp'", 'max_length': '5'}),
            'homer_server': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
