...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PyfbSettings.account2_currency'
        db.alter_column('pyfbsettings', 'account2_currency_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['currencies.Currency']))

        # Changing field 'PyfbSettings.account3_currency'
        db.alter_column('pyfbsettings', 'account3_currency_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['currencies.Currency']))

        # Changing field 'PyfbSettings.default_currency'
        db.alter_column('pyfbsettings', 'default_currency_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['currencies.Currency']))

        # Changing field 'PyfbSettings.account1_currency'
        db.alter_column('pyfbsettings', 'account1_currency_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['currencies.Currency']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PyfbSettings.account2_currency'
        raise RuntimeError("Cannot reverse this migration. 'PyfbSettings.account2_currency' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'PyfbSettings.account2_currency'
        db.alter_column('pyfbsettings', 'account2_currency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['currencies.Currency']))

        # User chose to not deal with backwards NULL issues for 'PyfbSettings.account3_currency'
        raise RuntimeError("Cannot reverse this migration. 'PyfbSettings.account3_currency' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'PyfbSettings.account3_currency'
        db.alter_column('pyfbsettings', 'account3_currency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['currencies.Currency']))

        # User chose to not deal with backwards NULL issues for 'PyfbSettings.default_currency'
        raise RuntimeError("Cannot reverse this migration. 'PyfbSettings.default_currency' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'PyfbSettings.default_currency'
        db.alter_column('pyfbsettings', 'default_currency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['currencies.Currency']))

        # User chose to not deal with backwards NULL issues for 'PyfbSettings.account1_currency'
        raise RuntimeError("Cannot reverse this migration. 'PyfbSettings.account1_currency' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'PyfbSettings.account1_currency'
        db.alter_column('pyfbsettings', 'account1_currency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['currencies.Currency']))
    ...
    models = {
        ...
        u'pyfreebill.pyfbsettings': {
            ...
            'account1': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'account1_currency': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'account1_currency'", 'null': 'True', 'to': u"orm['currencies.Currency']"}),
            'account1_iban': ('django_iban.fields.IBANField', [], {'max_length': '34', 'null': 'True', 'blank': 'True'}),
            'account1_swift_bic': ('django_iban.fields.SWIFTBICField', [], {'max_length': '11', 'null': 'True', 'blank': 'True'}),
            'account2': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'account2_currency': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'account2_currency'", 'null': 'True', 'to': u"orm['currencies.Currency']"}),
            'account2_iban': ('django_iban.fields.IBANField', [], {'max_length': '34', 'null': 'True', 'blank': 'True'}),
            'account2_swift_bic': ('django_iban.fields.SWIFTBICField', [], {'max_length': '11', 'null': 'True', 'blank': 'True'}),
            'account3': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'account3_currency': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'account3_currency'", 'null': 'True', 'to': u"orm['currencies.Currency']"}),
            'account3_iban': ('django_iban.fields.IBANField', [], {'max_length': '34', 'null': 'True', 'blank': 'True'}),
            'account3_swift_bic': ('django_iban.fields.SWIFTBICField', [], {'max_length': '11', 'null': 'True', 'blank': 'True'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
